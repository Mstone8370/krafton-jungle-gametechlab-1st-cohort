...
void FEditorRenderPass::RenderArrowInstanced()
{
    ...
    int32 BufferIndex = 0;
    for (uint32 i = 0; i < (1 + static_cast<uint32>(BufferAll.Num()) / ConstantBufferSizeArrow) * ConstantBufferSizeArrow; ++i)
    {
...
void FEditorRenderPass::RenderCapsuleInstanced(uint64 ShowFlag)
{
    ...
    int BufferIndex = 0;
    for (uint32 i = 0; i < (1 + static_cast<uint32>(BufferAll.Num()) / ConstantBufferSizeCapsule) * ConstantBufferSizeCapsule; ++i)
    {
